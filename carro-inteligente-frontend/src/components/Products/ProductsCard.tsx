...
const ProductCard = ({ product, onAddToCart }: Props) => {
  return (
    <div className="product-card" style={{ padding: '1rem', border: '1px solid #ccc', borderRadius: '8px', width: '100%', maxWidth: '320px', margin: '0 auto', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
      ...
      <p style={{ margin: '0.25rem 0',color: '#000000' }}><strong>Marca:</strong> {product.brand}</p>
      <p style={{ margin: '0.25rem 0',color: '#000000'  }}><strong>Precio:</strong> ${product.price.toLocaleString()} CLP</p>
      <p style={{ margin: '0.25rem 0',color: '#000000'  }}><strong>Stock:</strong> {product.stock}</p>
